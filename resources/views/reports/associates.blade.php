...
@section('content')
    <div class="search-area">
        ...
        <form action="{{ route('reports.associates') }}" method="get" autocomplete="off" id="search"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <input type="hidden" name="type" value="associates">
                                </div>
                                <div class="form-group col-md-4 mb-3">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <a href="{{ route('reports.associates', ['type' => 'associates']) }}"
                                        class="ml-5">Clear
                                        Search</a>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php $counter = 1; ?>
                                @foreach ($associateReports as $key => $item)
                                    <tr>
                                        <td class="text-center">{{ $associateReports->firstItem() + $key }}</td>
                                        <td class="text-center">{{ $item->associate->hrms_id }}</td>
                                        <td class="text-center">{{ $item->associate->name }}</td>
                    ...
                    {{ $associateReports->appends(request()->input())->links('vendor.pagination.default') }}
                    <small>Showing {{ $associateReports->firstItem() }} to {{ $associateReports->lastItem() }} of
                        {{ $associateReports->total() }}
                        entries</small>
                </div>
            </div>
        </div>
