...
@section('content')
    ...
    <div class="search-area">
        ...
        <form action="{{ route('reports.timesheet') }}" method="get" autocomplete="off">
            ...
            <div class="card card-primary card-outline mt-3" id="search"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="user_id" class="form-control select2">
                                ...
                                @foreach ($evaluators as $evaluator)
                                    <option value="{{ $evaluator->hrms_id }}" @if ($evaluator->hrms_id == $user_id) selected @endif>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('reports.timesheet') }}" class="ml-5">Clear Search</a>
                </div>
            </div>
        </form>
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @if (count($timeSheetReports) > 0)
                        @foreach ($timeSheetReports as $item)
                            @php
                                $handling_time = 0;
                                $avg_handling_time = 0;
                                $calling_time = 0;
        ...
        @if ($timeSheetReports->total() > 15)
            <!-- /.card-body -->
            <div class="card-footer clearfix">
                {{ $timeSheetReports->appends(request()->input())->links() }}
            </div>
            <!-- /.card-footer-->
        @endif
    </div>
