...
@section('content')
    <div class="search-area">
        ...
        <form action="{{ route('reports.campaigns') }}" method="get" autocomplete="off" id="search"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <a href="{{ route('reports.campaigns', ['type' => 'campaigns']) }}" class="ml-5">Clear
                                        Search</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($campaignReports as $key => $item)
                                    <tr>
                                        <td class="text-center">{{ $campaignReports->firstItem() + $key }}</td>
                    ...
                    {{ $campaignReports->appends(request()->input())->links('vendor.pagination.default') }}
                    <small>Showing {{ $campaignReports->firstItem() }} to {{ $campaignReports->lastItem() }} of
                        {{ $campaignReports->total() }}
                        entries</small>
                </div>
            </div>
        </div>
